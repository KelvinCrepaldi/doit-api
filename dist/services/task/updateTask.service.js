...
const updateTaskService = ({ title, taskId, userId, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (task.concluded === true) {
        throw new appErrors_1.AppError(403, "Esta tarefa já foi concluída e não pode ser modificada.");
    }
