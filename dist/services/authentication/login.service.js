...
const loginService = ({ email, password, }) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!user) {
        throw new appErrors_1.AppError(404, "O usuário com o e-mail fornecido não existe em nosso sistema. Verifique suas credenciais ou crie uma nova conta.");
    }
    const passwordMatch = yield bcryptjs_1.default.compare(password, user.password);
    if (!passwordMatch) {
        throw new appErrors_1.AppError(404, "A senha fornecida não corresponde à senha associada a este usuário. Verifique suas credenciais e tente novamente.");
    }
